/* !! commented out statements breaks compilation */
...
public:
  ...
  //  virtual int F1() = 0 ;
  virtual int F1() { return Base__protectedData ; }
...
//  int F2()   { return Base__protectedData + TEN + ONE ; }
  ...
  int F1()   { return Derived__privateData             ; }
  int F2()   { return Derived__privateData + TEN + ONE ; }
} ;
